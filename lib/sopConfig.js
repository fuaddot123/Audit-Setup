...
// ── Penanda "item kondisi" — item yang sebenarnya soal kondisi/fungsi aset & fasilitas
// (rusak/berfungsi), bukan soal kepatuhan proses/perilaku. Murni buat badge visual di
// UI checklist & laporan — TIDAK mengubah kategori, bobot skor, atau item kritis sama
// sekali, jadi nggak ada risiko ke skor historis maupun perbandingan bulan ke bulan.
export const CONDITION_ITEMS = new Set([
  "display_11",        // Backdrop display menyala normal
  "display_12",        // Tidak ada unit rusak di display
  "display_16",        // Semua lampu ruangan berfungsi normal
  "toilet_2",           // Air mengalir lancar
  "toilet_4",           // Closet tidak berkerak dan berfungsi
  "toilet_7",           // Saluran air lancar
  "nonoperasional_0",   // Tidak ada lantai yang berkerak/rusak
]);
